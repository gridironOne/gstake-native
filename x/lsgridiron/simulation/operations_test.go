...
func createTestApp(t *testing.T, isCheckTx bool) (*chain.GstakeApp, sdk.Context) {
...
func getTestingAccounts(t *testing.T, r *rand.Rand, app *chain.GstakeApp, ctx sdk.Context, n int) []simtypes.Account {
...
func getTestingValidator0(t *testing.T, app *chain.GstakeApp, ctx sdk.Context, accounts []simtypes.Account) stakingtypes.Validator {
...
func getTestingValidator1(t *testing.T, app *chain.GstakeApp, ctx sdk.Context, accounts []simtypes.Account) stakingtypes.Validator {
...
func getTestingValidator(t *testing.T, app *chain.GstakeApp, ctx sdk.Context, accounts []simtypes.Account, commission stakingtypes.Commission, n int) stakingtypes.Validator {
	account := accounts[n]
