...
func (k Keeper) SendProtocolFee(ctx sdk.Context, protocolFee sdk.Coins, moduleAccount, gstakeFeeAddressString string) error {
	addr, err := sdk.AccAddressFromBech32(gstakeFeeAddressString)
	if err != nil {
		return err
	}
