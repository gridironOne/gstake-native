	...
	testCases := []struct {
	...
	}{
		{
			...
			ExpectedListWithUndelegateDistribution: []types.ValAddressAmounts{
				...
				{
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1hcqg5wj9t42zawqkqucs7la85ffyv08le09ljt", Amount: sdk.NewCoin("uatom", sdk.NewInt(200))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1lcck2cxh7dzgkrfk53kysg9ktdrsjj6jfwlnm2", Amount: sdk.NewCoin("uatom", sdk.NewInt(22))},
				},
				{
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1hcqg5wj9t42zawqkqucs7la85ffyv08le09ljt", Amount: sdk.NewCoin("uatom", sdk.NewInt(200))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1lcck2cxh7dzgkrfk53kysg9ktdrsjj6jfwlnm2", Amount: sdk.NewCoin("uatom", sdk.NewInt(23))},
				},
				{
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1hcqg5wj9t42zawqkqucs7la85ffyv08le09ljt", Amount: sdk.NewCoin("uatom", sdk.NewInt(200))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1lcck2cxh7dzgkrfk53kysg9ktdrsjj6jfwlnm2", Amount: sdk.NewCoin("uatom", sdk.NewInt(100))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper10khgeppewe4rgfrcy809r9h00aquwxxxgwgwa5", Amount: sdk.NewCoin("uatom", sdk.NewInt(100))},
				},
				{
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1hcqg5wj9t42zawqkqucs7la85ffyv08le09ljt", Amount: sdk.NewCoin("uatom", sdk.NewInt(200))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1lcck2cxh7dzgkrfk53kysg9ktdrsjj6jfwlnm2", Amount: sdk.NewCoin("uatom", sdk.NewInt(100))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper10khgeppewe4rgfrcy809r9h00aquwxxxgwgwa5", Amount: sdk.NewCoin("uatom", sdk.NewInt(200))},
				},
				{
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1hcqg5wj9t42zawqkqucs7la85ffyv08le09ljt", Amount: sdk.NewCoin("uatom", sdk.NewInt(200))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1lcck2cxh7dzgkrfk53kysg9ktdrsjj6jfwlnm2", Amount: sdk.NewCoin("uatom", sdk.NewInt(100))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper10khgeppewe4rgfrcy809r9h00aquwxxxgwgwa5", Amount: sdk.NewCoin("uatom", sdk.NewInt(400))},
				},
			},
		},
		{
			...
			ExpectedListWithDelegateDistribution: []types.ValAddressAmounts{
				{
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1083svrca4t350mphfv9x45wq9asrs60cdmrflj", Amount: sdk.NewCoin("uatom", sdk.NewInt(0))},
				...
				},
				{
					...
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1vvwtk805lxehwle9l4yudmq6mn0g32px9xtkhc", Amount: sdk.NewCoin("uatom", sdk.NewInt(0))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1xwazl8ftks4gn00y5x3c47auquc62ssuqlj02r", Amount: sdk.NewCoin("uatom", sdk.NewInt(0))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1y0us8xvsvfvqkk9c6nt5cfyu5au5tww2ztve7q", Amount: sdk.NewCoin("uatom", sdk.NewInt(2))},
				},
				{
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1083svrca4t350mphfv9x45wq9asrs60cdmrflj", Amount: sdk.NewCoin("uatom", sdk.NewInt(0))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper10e4vsut6suau8tk9m6dnrm0slgd6npe3jx5xpv", Amount: sdk.NewCoin("uatom", sdk.NewInt(0))},
					...
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1vvwtk805lxehwle9l4yudmq6mn0g32px9xtkhc", Amount: sdk.NewCoin("uatom", sdk.NewInt(0))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1xwazl8ftks4gn00y5x3c47auquc62ssuqlj02r", Amount: sdk.NewCoin("uatom", sdk.NewInt(0))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1y0us8xvsvfvqkk9c6nt5cfyu5au5tww2ztve7q", Amount: sdk.NewCoin("uatom", sdk.NewInt(10))},
				},
				{
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1y0us8xvsvfvqkk9c6nt5cfyu5au5tww2ztve7q", Amount: sdk.NewCoin("uatom", sdk.NewInt(1))},
				...
				{
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1y0us8xvsvfvqkk9c6nt5cfyu5au5tww2ztve7q", Amount: sdk.NewCoin("uatom", sdk.NewInt(4))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1xwazl8ftks4gn00y5x3c47auquc62ssuqlj02r", Amount: sdk.NewCoin("uatom", sdk.NewInt(4))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1vvwtk805lxehwle9l4yudmq6mn0g32px9xtkhc", Amount: sdk.NewCoin("uatom", sdk.NewInt(4))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1vf44d85es37hwl9f4h9gv0e064m0lla60j9luj", Amount: sdk.NewCoin("uatom", sdk.NewInt(4))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1v5y0tg0jllvxf5c3afml8s3awue0ymju89frut", Amount: sdk.NewCoin("uatom", sdk.NewInt(4))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1uutuwrwt3z2a5z8z3uasml3rftlpmu25aga5c6", Amount: sdk.NewCoin("uatom", sdk.NewInt(4))},
					...
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper13x77yexvf6qexfjg9czp6jhpv7vpjdwwkyhe4p", Amount: sdk.NewCoin("uatom", sdk.NewInt(2))},
				},
				{
			...
			ExpectedListWithUndelegateDistribution: []types.ValAddressAmounts{
				...
				},
				{
					...
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1083svrca4t350mphfv9x45wq9asrs60cdmrflj", Amount: sdk.NewCoin("uatom", sdk.NewInt(1339500))},
				},
				{
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1sjllsnramtg3ewxqwwrwjxfgc4n4ef9u2lcnj0", Amount: sdk.NewCoin("uatom", sdk.NewInt(1339690))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper10e4vsut6suau8tk9m6dnrm0slgd6npe3jx5xpv", Amount: sdk.NewCoin("uatom", sdk.NewInt(1339554))},
					...
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper124maqmcqv8tquy764ktz7cu0gxnzfw54n3vww8", Amount: sdk.NewCoin("uatom", sdk.NewInt(1339524))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper10nzaaeh2kq28t3nqsh5m8kmyv90vx7ym5mpakx", Amount: sdk.NewCoin("uatom", sdk.NewInt(1339524))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1083svrca4t350mphfv9x45wq9asrs60cdmrflj", Amount: sdk.NewCoin("uatom", sdk.NewInt(1339520))},
				},
				{
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1sjllsnramtg3ewxqwwrwjxfgc4n4ef9u2lcnj0", Amount: sdk.NewCoin("uatom", sdk.NewInt(1339690))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper10e4vsut6suau8tk9m6dnrm0slgd6npe3jx5xpv", Amount: sdk.NewCoin("uatom", sdk.NewInt(1339554))},
					...
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper124maqmcqv8tquy764ktz7cu0gxnzfw54n3vww8", Amount: sdk.NewCoin("uatom", sdk.NewInt(1339524))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper10nzaaeh2kq28t3nqsh5m8kmyv90vx7ym5mpakx", Amount: sdk.NewCoin("uatom", sdk.NewInt(1339524))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1083svrca4t350mphfv9x45wq9asrs60cdmrflj", Amount: sdk.NewCoin("uatom", sdk.NewInt(1339523))},
				},
				{
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper1sjllsnramtg3ewxqwwrwjxfgc4n4ef9u2lcnj0", Amount: sdk.NewCoin("uatom", sdk.NewInt(1339690))},
					types.ValAddressAmount{ValidatorAddr: "cosmosvaloper10e4vsut6suau8tk9m6dnrm0slgd6npe3jx5xpv", Amount: sdk.NewCoin("uatom", sdk.NewInt(1339554))},
