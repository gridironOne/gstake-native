...
- `GstakeAddress` : Address set as gstake fee address
...
- `GstakeParams` : Gstake params consists of different types of fees and gstake fee address
...
- `GstakeAddress` : Address from which this transaction is being sent (should be gstakeAddress).
