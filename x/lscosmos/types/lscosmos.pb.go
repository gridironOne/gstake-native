...
// source: gstake/lscosmos/v1beta1/lscosmos.proto
...
func (*AllowListedValidators) Descriptor() ([]byte, []int) {
	return fileDescriptor_26296f4c8983010b, []int{0}
}
...
func (*AllowListedValidator) Descriptor() ([]byte, []int) {
	return fileDescriptor_26296f4c8983010b, []int{1}
}
...
type GstakeParams struct {
	GstakeDepositFee    github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=gstake_deposit_fee,json=gstakeDepositFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"gstake_deposit_fee"`
	GstakeRestakeFee    github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=gstake_restake_fee,json=gstakeRestakeFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"gstake_restake_fee"`
	GstakeUnstakeFee    github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=gstake_unstake_fee,json=gstakeUnstakeFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"gstake_unstake_fee"`
	GstakeRedemptionFee github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,4,opt,name=gstake_redemption_fee,json=gstakeRedemptionFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"gstake_redemption_fee"`
	GstakeFeeAddress    string                                 `protobuf:"bytes,5,opt,name=gstake_fee_address,json=gstakeFeeAddress,proto3" json:"gstake_fee_address,omitempty"`
}

func (m *GstakeParams) Reset()         { *m = GstakeParams{} }
func (m *GstakeParams) String() string { return proto.CompactTextString(m) }
func (*GstakeParams) ProtoMessage()    {}
func (*GstakeParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_26296f4c8983010b, []int{2}
}
func (m *GstakeParams) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GstakeParams) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GstakeParams.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GstakeParams) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GstakeParams.Merge(m, src)
}
func (m *GstakeParams) XXX_Size() int {
	return m.Size()
}
func (m *GstakeParams) XXX_DiscardUnknown() {
	xxx_messageInfo_GstakeParams.DiscardUnknown(m)
}

var xxx_messageInfo_GstakeParams proto.InternalMessageInfo
...
type HostChainParams struct {
	...
	GstakeParams    GstakeParams                           `protobuf:"bytes,8,opt,name=gstake_params,json=gstakeParams,proto3" json:"gstake_params"`
}
...
func (*HostChainParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_26296f4c8983010b, []int{3}
}
...
func (*DelegationState) Descriptor() ([]byte, []int) {
	return fileDescriptor_26296f4c8983010b, []int{4}
}
...
func (*HostAccountDelegation) Descriptor() ([]byte, []int) {
	return fileDescriptor_26296f4c8983010b, []int{5}
}
...
func (*HostAccountUndelegation) Descriptor() ([]byte, []int) {
	return fileDescriptor_26296f4c8983010b, []int{6}
}
...
func (*UndelegationEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_26296f4c8983010b, []int{7}
}
...
func (*HostChainRewardAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_26296f4c8983010b, []int{8}
}
...
func (*IBCAmountTransientStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_26296f4c8983010b, []int{9}
}
...
func (*TransientUndelegationTransfer) Descriptor() ([]byte, []int) {
	return fileDescriptor_26296f4c8983010b, []int{10}
}
...
func (*UnbondingEpochCValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_26296f4c8983010b, []int{11}
}
...
func (*DelegatorUnbondingEpochEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_26296f4c8983010b, []int{12}
}
...
func (*HostAccounts) Descriptor() ([]byte, []int) {
	return fileDescriptor_26296f4c8983010b, []int{13}
}
...
func init() {
	proto.RegisterType((*AllowListedValidators)(nil), "gstake.lscosmos.v1beta1.AllowListedValidators")
	proto.RegisterType((*AllowListedValidator)(nil), "gstake.lscosmos.v1beta1.AllowListedValidator")
	proto.RegisterType((*GstakeParams)(nil), "gstake.lscosmos.v1beta1.GstakeParams")
	proto.RegisterType((*HostChainParams)(nil), "gstake.lscosmos.v1beta1.HostChainParams")
	proto.RegisterType((*DelegationState)(nil), "gstake.lscosmos.v1beta1.DelegationState")
	proto.RegisterType((*HostAccountDelegation)(nil), "gstake.lscosmos.v1beta1.HostAccountDelegation")
	proto.RegisterType((*HostAccountUndelegation)(nil), "gstake.lscosmos.v1beta1.HostAccountUndelegation")
	proto.RegisterType((*UndelegationEntry)(nil), "gstake.lscosmos.v1beta1.UndelegationEntry")
	proto.RegisterType((*HostChainRewardAddress)(nil), "gstake.lscosmos.v1beta1.HostChainRewardAddress")
	proto.RegisterType((*IBCAmountTransientStore)(nil), "gstake.lscosmos.v1beta1.IBCAmountTransientStore")
	proto.RegisterType((*TransientUndelegationTransfer)(nil), "gstake.lscosmos.v1beta1.TransientUndelegationTransfer")
	proto.RegisterType((*UnbondingEpochCValue)(nil), "gstake.lscosmos.v1beta1.UnbondingEpochCValue")
	proto.RegisterType((*DelegatorUnbondingEpochEntry)(nil), "gstake.lscosmos.v1beta1.DelegatorUnbondingEpochEntry")
	proto.RegisterType((*HostAccounts)(nil), "gstake.lscosmos.v1beta1.HostAccounts")
}

func init() {
	proto.RegisterFile("gstake/lscosmos/v1beta1/lscosmos.proto", fileDescriptor_26296f4c8983010b)
}

var fileDescriptor_26296f4c8983010b = []byte{
	...
	,
}
...
func (this *GstakeParams) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GstakeParams)
	if !ok {
		that2, ok := that.(GstakeParams)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.GstakeDepositFee.Equal(that1.GstakeDepositFee) {
		return false
	}
	if !this.GstakeRestakeFee.Equal(that1.GstakeRestakeFee) {
		return false
	}
	if !this.GstakeUnstakeFee.Equal(that1.GstakeUnstakeFee) {
		return false
	}
	if !this.GstakeRedemptionFee.Equal(that1.GstakeRedemptionFee) {
		return false
	}
	if this.GstakeFeeAddress != that1.GstakeFeeAddress {
		return false
	}
	return true
}
func (this *HostChainParams) Equal(that interface{}) bool {
	...
	if !this.GstakeParams.Equal(&that1.GstakeParams) {
		return false
	}
	return true
}
...
func (m *GstakeParams) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GstakeParams) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GstakeParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.GstakeFeeAddress) > 0 {
		...
		i = encodeVarintLscosmos(dAtA, i, uint64(len(m.GstakeFeeAddress)))
		i--
		dAtA[i] = 0x2a
	}
	{
...
func (m *HostChainParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.GstakeParams.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *GstakeParams) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GstakeParams) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GstakeParams: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GstakeParams: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *HostChainParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GstakeParams", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.GstakeParams.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
