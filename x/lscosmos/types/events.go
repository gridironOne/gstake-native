...
const (
	...
	AttributePstakeDepositFee      = "gstake-deposit-fee"
	AttributePstakeRedeemFee       = "gstake-redeem-fee"
	AttributePstakeUnstakeFee      = "gstake-unstake-fee"
	AttributeDelegatorAddress      = "address"
	AttributeRewarderAddress       = "rewarder-address"
	AttributeClaimedAmount         = "claimed-amount"
	AttributePstakeAddress         = "gstake-address"
