...
type MinDepositAndFeeChangeProposal struct {
	...
	PstakeDepositFee    github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,4,opt,name=gstake_deposit_fee,json=gstakeDepositFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"gstake_deposit_fee"`
	PstakeRestakeFee    github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,5,opt,name=gstake_restake_fee,json=gstakeRestakeFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"gstake_restake_fee"`
	PstakeUnstakeFee    github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,6,opt,name=gstake_unstake_fee,json=gstakeUnstakeFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"gstake_unstake_fee"`
	PstakeRedemptionFee github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,7,opt,name=gstake_redemption_fee,json=gstakeRedemptionFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"gstake_redemption_fee"`
}
...
func init() {
	...
	proto.RegisterType((*PstakeFeeAddressChangeProposal)(nil), "gstake.lscosmos.v1beta1.PstakeFeeAddressChangeProposal")
