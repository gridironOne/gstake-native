...
func TestMsgLiquidStakeValidation(t *testing.T) {
	...
	cases := []struct {
		...
		{"gridiron12p6hyur0wdjkvatvd3ujqmr0denjqctyv3ex2umn4nhuy6: invalid address", types.NewMsgLiquidStake(atom123, addrLong)}, // invalid send with long addr sender
...
func TestNewMsgLiquidStakeGetSignBytes(t *testing.T) {
	...
	excepted := `{"type":"cosmos/MsgLiquidStake","value":{"amount":{"amount":"10","denom":"atom"},"delegator_address":"gridiron1d9h8qat5et0urd"}}`
