...
func newTestApp(t *testing.T, isCheckTx bool, _ bool) app.GstakeApp {
	testApp := Setup(t, isCheckTx, 5)
	return *testApp
}

func CreateTestApp(t *testing.T) (*codec.LegacyAmino, app.GstakeApp, sdk.Context) {
...
func setup(withGenesis bool, invCheckPeriod uint) (*app.GstakeApp, app.GenesisState) {
	db := dbm.NewMemDB()
...
func Setup(t *testing.T, isCheckTx bool, invCheckPeriod uint) *app.GstakeApp {
	t.Helper()
...
func genesisStateWithValSet(t *testing.T,
	app *app.GstakeApp, genesisState app.GenesisState,
...
func SetupWithGenesisValSet(t *testing.T, valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, balances ...banktypes.Balance) *app.GstakeApp {
	t.Helper()
...
func AddTestAddrsFromPubKeys(app *app.GstakeApp, ctx sdk.Context, pubKeys []cryptotypes.PubKey, accAmt math.Int) {
...
func AddTestAddrs(app *app.GstakeApp, ctx sdk.Context, accNum int, accAmt math.Int) []sdk.AccAddress {
	return addTestAddrs(app, ctx, accNum, accAmt, createRandomAccounts)
}

// AddTestAddrs constructs and returns accNum amount of accounts with an
// initial balance of accAmt in random order
func AddTestAddrsIncremental(app *app.GstakeApp, ctx sdk.Context, accNum int, accAmt math.Int) []sdk.AccAddress {
	return addTestAddrs(app, ctx, accNum, accAmt, createIncrementalAccounts)
}

type GenerateAccountStrategy func(int) []sdk.AccAddress

func addTestAddrs(app *app.GstakeApp, ctx sdk.Context, accNum int, accAmt math.Int, strategy GenerateAccountStrategy) []sdk.AccAddress {
...
func InitAccountWithCoins(app *app.GstakeApp, ctx sdk.Context, addr sdk.AccAddress, coins sdk.Coins) {
...
func CheckBalance(t *testing.T, app *app.GstakeApp, addr sdk.AccAddress, balances sdk.Coins) {
