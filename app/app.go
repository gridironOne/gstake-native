...
import (
	...
	gstakeante "github.com/gridironOne/gstake-native/ante"
	gstakeappparams "github.com/gridironOne/gstake-native/app/params"
	"github.com/gridironOne/gstake-native/x/liquidstakeibc"
	liquidstakeibckeeper "github.com/gridironOne/gstake-native/x/liquidstakeibc/keeper"
	liquidstakeibctypes "github.com/gridironOne/gstake-native/x/liquidstakeibc/types"
	"github.com/gridironOne/gstake-native/x/lscosmos"
	lscosmosclient "github.com/gridironOne/gstake-native/x/lscosmos/client"
	lscosmoskeeper "github.com/gridironOne/gstake-native/x/lscosmos/keeper"
	lscosmostypes "github.com/gridironOne/gstake-native/x/lscosmos/types"
	"github.com/gridironOne/gstake-native/x/lsgridiron"
	lsgridironkeeper "github.com/gridironOne/gstake-native/x/lsgridiron/keeper"
	lsgridirontypes "github.com/gridironOne/gstake-native/x/lsgridiron/types"
)
...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		gov.NewAppModuleBasic([]govclient.ProposalHandler{paramsclient.ProposalHandler,
			...
			lscosmosclient.GstakeFeeAddressChangeProposalHandler,
...
var (
	_ simapp.App                          = (*GstakeApp)(nil)
	_ servertypes.Application             = (*GstakeApp)(nil)
	_ ibctesting.TestingApp               = (*GstakeApp)(nil)
	_ servertypes.ApplicationQueryService = (*GstakeApp)(nil)
)

// GstakeApp extends an ABCI application, but with most of its parameters exported.
// They are exported for convenience in creating helper functions, as object
// capabilities aren't needed for testing.
type GstakeApp struct {
	*baseapp.BaseApp
...
func (app *GstakeApp) Name() string { return app.BaseApp.Name() }

// BeginBlocker application updates every begin block
func (app *GstakeApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

// EndBlocker application updates every end block
func (app *GstakeApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// InitChainer application update at chain initialization
func (app *GstakeApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *GstakeApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *GstakeApp) ModuleAccountAddrs() map[string]bool {
...
func (app *GstakeApp) SendCoinBlockedAddrs() map[string]bool {
	modAccAddrs := make(map[string]bool)
	for acc := range maccPerms {
...
// LegacyAmino returns GstakeApp's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *GstakeApp) LegacyAmino() *codec.LegacyAmino {
...
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *GstakeApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns gStake's InterfaceRegistry
func (app *GstakeApp) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *GstakeApp) GetKey(storeKey string) *store.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *GstakeApp) GetTKey(storeKey string) *store.TransientStoreKey {
...
func (app *GstakeApp) GetMemKey(storeKey string) *store.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *GstakeApp) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

// SimulationManager implements the SimulationApp interface
func (app *GstakeApp) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *GstakeApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *GstakeApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *GstakeApp) RegisterTendermintService(clientCtx client.Context) {
...
func (app *GstakeApp) RegisterNodeService(clientCtx client.Context) {
...
func (app *GstakeApp) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *GstakeApp) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *GstakeApp) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *GstakeApp) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *GstakeApp) GetTxConfig() client.TxConfig {
